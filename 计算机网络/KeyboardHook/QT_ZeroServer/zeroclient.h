...
public:
    ...
    const QByteArray CmdKeyboardStop = "KEYBOARD_Stop";
    const QByteArray CmdKeyboardTakeOver = "KEYBOARD_TakeOver";
    ...
    void sendKeyboardStop(int port);
    void sendKeyboardTakeOver(QString &text);
