...
insert  into `ct`(`ctid`,`cid`,`tid`,`term`) values (5,8,4,'2023夏'),(6,7,4,'2023夏'),(7,10,13,'2023夏'),(8,9,13,'2023夏'),(9,11,4,'2023夏'),(10,9,4,'2023夏');
...
insert  into `s`(`sid`,`sname`,`password`) values (1,'阮健乘','1234'),(2,'张四','123'),(3,'李四','1234'),(4,'彭昊辉','123456'),(6,'林春霞','123'),(7,'董一超','12345'),(8,'董超','123'),(9,'张千','8081'),(10,'李万','10085'),(14,'薇尔莉特','123'),(21,'庄亮','123'),(22,'钟平','1234'),(23,'李煜豪','123');
...
insert  into `sct`(`sctid`,`sid`,`cid`,`tid`,`grade`,`term`) values (10,2,8,4,2,'2023夏'),(11,2,10,13,NULL,'2023夏'),(12,2,7,4,5,'2023夏'),(13,4,8,4,10,'2023夏'),(14,4,7,4,NULL,'2023夏'),(15,4,10,13,NULL,'2023夏'),(16,1,8,4,NULL,'2023夏'),(17,1,10,13,NULL,'2023夏');
